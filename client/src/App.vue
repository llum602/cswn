<template>
  <div id="app">
    ...
    <!-- ************* lil space *************** -->
    <div id="top" class="fuck" style="height:70px;">
        <p>get outta my code</p>
    </div>
    ...
    <!-- ************* Prizes *************** -->
    <div id="prizes" class="fuck">
            
        <h3 style="color:rgb(30, 89, 109);">Prizes</h3>
...
export default {
  ...
  methods: {
      ...
      async modifyScore() {
        ...
        var answers = ["Corn", "Seven Wonders Of The World", "The Kremlin", "Liberia", "alien", "Lets go to the beach", "", "Brussels", "Taipei taiwan", "Hawaii", "West Lafayette", "", "Travel makes the world modest, you see what a tiny place you occupy in the world",];
